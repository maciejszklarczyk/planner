    ...
    return (
        <div className="pointer-events-none absolute inset-0">
            ...
            <div
                ...
                style={{
                    backgroundImage: 'radial-gradient(circle, #4be277 1.5px, transparent 1.5px)',
                    backgroundSize: '28px 28px',
                    maskImage: 'radial-gradient(circle 160px at -999px -999px, black 0%, transparent 100%)',
                    WebkitMaskImage: 'radial-gradient(circle 160px at -999px -999px, black 0%, transparent 100%)',
                }}
            />
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, rgba(132,204,22,0.25) 0%, transparent 65%)',
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, rgba(75,226,119,0.10) 0%, transparent 60%)',
                }}
            />
        </div>
    );
