...
> = {
  ...
  "2": {
    name: "Warsztaty UX Design",
    startDate: "2026-04-24",
    location: "Studio Kreatywne, Kraków",
    category: "Design",
    attendees: 30,
  },
  "3": {
    name: "Hackathon AI 2025",
    startDate: "2026-05-22",
    location: "Hub Innowacji, Wrocław",
    category: "AI/ML",
    attendees: 80,
  },
  "4": {
    name: "Meetup React Warsaw",
    startDate: "2026-06-01",
    location: "Coworking Space, Warszawa",
    category: "Frontend",
    attendees: 50,
  },
  "5": {
    ...
    location: "Hotel Marriott, Gdańsk",
    category: "DevOps",
    attendees: 200,
  },
};
...
export default function EventDetailLayout({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(v) => router.push(`/events/${id}/${v}`)}
      >
        <TabsList>
          {TABS.map((tab) => (
